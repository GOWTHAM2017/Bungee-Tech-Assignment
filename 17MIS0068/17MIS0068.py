...
new_data.to_csv(r'gowtham\modify_filtered_country.csv',index=False)

first_and_second_min_prices = pd.read_csv(r"gowtham\modify_filtered_country.csv")
...
temp_data.to_csv(r'gowtham\t_lowest_price.csv',index_label="SKU")
df = pd.read_csv(r"gowtham\t_lowest_price.csv")
